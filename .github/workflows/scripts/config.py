...
# 仓库配置
KSU_REPO_CONFIG = {"repo_url": "https://github.com/Asu1tty/SukiSU-Ultra.git",
                    "branch": "main",
                    "setup_script": "https://raw.githubusercontent.com/Asu1tty/SukiSU-Ultra/main/kernel/setup.sh"}
